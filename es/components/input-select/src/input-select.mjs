...
const isInputSelectLayout = (value) => isArray(value) && value.length === 2 && value.every((item) => inputSelectControlTypes.includes(item));
...
export { inputSelectControlTypes, inputSelectEmits, inputSelectProps };
//# sourceMappingURL=input-select.mjs.map
