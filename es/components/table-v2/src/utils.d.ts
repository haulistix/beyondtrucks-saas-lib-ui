...
export declare const componentToSlot: <T extends object>(ComponentLike: JSX.Element | ((props: T) => VNode | VNode[] | null | undefined) | undefined) => Slot | ((props: T) => VNode<import("vue").RendererNode, import("vue").RendererElement, {
    [key: string]: any;
}>);
