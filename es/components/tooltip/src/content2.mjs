import { defineComponent, ref, inject, computed, onBeforeUnmount, unref, watch, openBlock, createBlock, withCtx, withDirectives, vShow, createCommentVNode, Transition, createVNode, mergeProps, renderSlot, nextTick } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const overlayZIndex = computed(() => props.modal ? zIndex.value - 1 : void 0);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ElTeleport), {
        ...
        default: withCtx(() => {
          var _a2;
          return [
            _ctx.modal ? withDirectives((openBlock(), createBlock(unref(ElOverlay), {
              key: 0,
              "overlay-class": [unref(ns).e("overlay"), (_a2 = _ctx.modalClass) != null ? _a2 : ""],
              "z-index": unref(overlayZIndex),
