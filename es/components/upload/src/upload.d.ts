...
export interface UploadHooks {
    ...
    onChange: (uploadFile: UploadFile, uploadFiles: UploadFiles, isEnd?: boolean) => void;
...
export declare const uploadProps: {
    ...
    readonly onChange: import("element-plus/es/utils").EpPropFinalized<(new (...args: any[]) => (uploadFile: UploadFile, uploadFiles: UploadFiles, isEnd?: boolean) => void) | (() => (uploadFile: UploadFile, uploadFiles: UploadFiles, isEnd?: boolean) => void) | {
        (): (uploadFile: UploadFile, uploadFiles: UploadFiles, isEnd?: boolean) => void;
        new (): any;
        readonly prototype: any;
    } | ((new (...args: any[]) => (uploadFile: UploadFile, uploadFiles: UploadFiles, isEnd?: boolean) => void) | (() => (uploadFile: UploadFile, uploadFiles: UploadFiles, isEnd?: boolean) => void) | {
        (): (uploadFile: UploadFile, uploadFiles: UploadFiles, isEnd?: boolean) => void;
        new (): any;
        readonly prototype: any;
    })[], unknown, unknown, () => void, boolean>;
