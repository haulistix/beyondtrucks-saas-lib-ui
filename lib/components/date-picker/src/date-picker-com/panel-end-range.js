  ...
  setup(__props, { emit }) {
    ...
    const disabledDate = (date) => {
      if (baseDisabledDate == null ? void 0 : baseDisabledDate(date))
        return true;
      return !!minDate.value && dayjs__default["default"](date).isBefore(minDate.value, "day");
    };
    const leftPrevYear = () => {
    ...
    const handleDatePick = (value, keepOpen = false) => {
      ...
      if (!nextDate)
        return;
      const { range, completed } = utils.getSequentialRangePick("end", selectingStartDate.value, nextDate, [minDate.value, maxDate.value]);
    ...
    const handleClear = () => {
      ...
      emit("pick", utils.getPartialRangePayload([remainingMinDate, void 0]).pickRange);
    };
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.unref(showFooter) && (vue.unref(clearable) || vue.unref(isOk)) ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
...
var DateEndRangePickPanel = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["__file", "panel-end-range.vue"]]);

exports["default"] = DateEndRangePickPanel;
//# sourceMappingURL=panel-end-range.js.map
