  ...
  setup(__props, { expose }) {
    ...
    vue.onMounted(() => {
      ...
      if (props.prop) {
        ...
        if (!isDisabled.value && isRequired.value && props.alwaysShowError && types.isEmpty(initialValue) && (((_a = formItemContent.value) == null ? void 0 : _a.querySelector(".el-input")) || ((_b = formItemContent.value) == null ? void 0 : _b.querySelector(".el-textarea")) || ((_c = formItemContent.value) == null ? void 0 : _c.querySelector(".el-date-editor")) || ((_d = formItemContent.value) == null ? void 0 : _d.querySelector(".el-select")))) {
