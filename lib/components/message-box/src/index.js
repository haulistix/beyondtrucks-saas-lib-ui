...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const boxStyle = vue.computed(() => ({
      [`--${ns.namespace.value}-messagebox-width`]: style.addUnit(state.width),
      ...state.customStyle
    }));
              ...
              default: vue.withCtx(() => [
                vue.createElementVNode("div", {
                  ...
                  _ctx.title !== null && _ctx.title !== void 0 ? (vue.openBlock(), vue.createElementBlock("div", {
                    ...
                    _ctx.showClose ? (vue.openBlock(), vue.createBlock(_component_el_button, {
                      key: 0,
                      type: "text",
                      class: vue.normalizeClass(["icon-button", _ctx.ns.e("headerbtn")]),
                      ...
                      _: 1
                    }, 8, ["class", "aria-label", "onClick", "onKeydown"])) : vue.createCommentVNode("v-if", true)
