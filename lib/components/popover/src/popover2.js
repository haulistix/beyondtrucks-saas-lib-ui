...
const popoverProps = runtime.buildProps({
  ...
  zIndex: content.useTooltipContentProps.zIndex,
  modal: content.useTooltipContentProps.modal,
  modalClass: content.useTooltipContentProps.modalClass,
  closeOnClickModal: content.useTooltipContentProps.closeOnClickModal,
  title: String,
  width: {
    type: [String, Number],
    default: 150
