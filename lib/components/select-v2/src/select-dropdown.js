...
var ElSelectMenu = vue.defineComponent({
  ...
  setup(props2, {
      ...
      return {
        ...
        itemSize: (idx) => {
          ...
          if (((_a2 = props2.data[idx]) == null ? void 0 : _a2.type) === "Group") {
            ...
            return defaults.SELECT_V2_GROUP_TITLE_HEIGHT + (hasDivider ? defaults.SELECT_V2_GROUP_DIVIDER_SIZE : 0);
          }
          if (idx === selectionDividerIndex.value) {
            return defaults.SELECT_V2_GROUP_DIVIDER_SIZE + defaults.SELECT_V2_GROUP_TITLE_HEIGHT + ((_b = cachedHeights.value[idx]) != null ? _b : estimatedSize);
          }
    ...
    return () => {
      ...
      const List = vue.unref(usesDynamicSizeList) ? dynamicSizeList["default"] : fixedSizeList["default"];
