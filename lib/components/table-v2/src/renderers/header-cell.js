...
const HeaderCellRenderer = (props, {
  ...
  const cellKls = [ns.e("header-cell"), column.required && "required-column", utils.tryCall(headerClass, props, ""), column.align === constants.Alignment.CENTER && ns.is("align-center"), column.align === constants.Alignment.RIGHT && ns.is("align-right"), sortable && ns.is("sortable")];
