...
declare function useEvents<T extends DefaultRow>(props: Partial<TableBodyProps<T>>, emit: (...args: any[]) => void): {
    ...
    handleRowMouseMove: (event: MouseEvent, row: T, rowIndex: number) => void;
    handleRowMouseOut: (event: MouseEvent) => void;
