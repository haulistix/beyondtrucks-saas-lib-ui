...
function useEvent(props, emit) {
  ...
  const handleCellMouseEnter = (event, row) => {
    ...
    if (util.isGreaterThan(limitWidth, cellChildWidth) || util.isGreaterThan(rangeHeight + verticalPadding, cellChildHeight) || util.isGreaterThan(cellChild.scrollWidth, cellChildWidth)) {
      util.createTablePopper({ effect: "light" }, summaryHeaderTitle ? (_d = cellChild.innerText || cellChild.textContent) != null ? _d : "" : (_e = (cell == null ? void 0 : cell.innerText) || (cell == null ? void 0 : cell.textContent)) != null ? _e : "", row, column, cell, table);
    } else if (((_f = util.removePopper) == null ? void 0 : _f.trigger) === cell) {
      (_g = util.removePopper) == null ? void 0 : _g();
    }
  };
